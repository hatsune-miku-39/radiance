            ...
            var radiance_pack = {
                character: {
                    ...
                    "radiance_he017_qilian": ["male", "radiance_group_heng", 3, ["radiance_lunxin", "radiance_zhihe"],
                        ["doublegroup:radiance_group_heng:radiance_group_magic"]
                    ],
                    ...
                    "radiance_ch021_samael": ["male", "radiance_group_church", 4, ["radiance_waidao", "radiance_diankuang"],
                        ["doublegroup:radiance_group_church:radiance_group_underworld"]
                    ],
                    ...
                    "radiance_001_aides": ["female", "radiance_group_free", 3, ["raidance_shenyi", "radiance_jinian"],
                        ['forbidai']
                    ],
                ...
                characterSort: {
                    "mode_extension_星耀璨然": {
                        "radiance_magic": [
                            ...
                            "radiance_ma017_ginga",
                            "radiance_ma021_raimund",
                        ],
                        "radiance_heng": [
                            ...
                            "radiance_he016_liyexin", "radiance_he017_qilian", "radiance_he018_daole",
                        ],
                        "radiance_union": [
                            ...
                            "radiance_un017_qiuguxun", "radiance_un018_kinsey",
                        ],
                        "radiance_church": [
                        ...
                        "radiance_underworld": [
                            ...
                            "radiance_ud011_crimsoul", "radiance_ud012_dreadknight",
                        ],
                        "radiance_lost": [],
                        "radiance_nonhuman": [
                        ...
                        "radiance_null": [
                            "radiance_000_infinity", "radiance_001_aides", "radiance_002_airin",
                        ],
                    },
                },
                skill: {},
                translate: {
                    ...
                    "radiance_un017_qiuguxun": "秋谷寻（测试）",
                ...
                dynamicTranslate: {
                    ...
                    "radiance_tenglong": function(player) {
                        if (player.storage.radiance_juesha === true) return "其他角色的出牌阶段开始时，你可以对该角色或其上下家使用一张【杀】。若如此做，你摸一张牌，其他角色与你计算距离时+1，直至回合结束。你使用【杀】时，<span class='firetext'>所有其他角色的防具和非锁定技全部失效直至此【杀】结算完毕</span>。";
                    ...
                    "radiance_tiancai": function(player) {
                        if (player.storage.radiance_tiancai) {
                            var list = [player.storage.radiance_tiancai.draw, player.storage.radiance_tiancai.give, player.storage.radiance_tiancai.add, player.storage.radiance_tiancai.look];
                            for (var i = 0; i < 4; i++) {
                            ...
                            return "①当你使用一张牌时，你可以根据其花色执行对应效果：·" + list[0] + "：摸一张牌；·" + list[1] + "：令一名其他角色获得此牌的实体牌；·" + list[2] + "：为此牌增加一个合法目标；·" + list[3] + "：摸两张牌然后弃两张牌。<br>②每次你的回合开始时，你可以切换①中花色与效果的对应顺序。"
                        };
                        return "①当你使用一张牌时，你可以根据其花色执行对应效果：·♥：摸一张牌；·♦：令一名其他角色获得此牌的实体牌；·♠：为此牌增加一个合法目标；·♣：摸两张牌然后弃两张牌。<br>②每次你的回合开始时，你可以切换①中花色与效果的对应顺序。";
                    },
        ...
        package: {
            ...
            skill: {
                skill: {
                    ...
                    "radiance_guiji": {
                        ...
                        content: function() {
                            'step 0'
                            var num = 1;
                            var str = "失去一点体力并改变" + get.translation(trigger.card) + "的目标"
                    ...
                    "radiance_jingti": {
                        ...
                        ai: {
                            effect: {
                                target: function(card, player, target, current) {
                                    if (target.getHistory('damage').length > 0 || target.getEquip(2)) return;
                    ...
                    "radiance_cangkong": {
                        ...
                        chooseButton: {
                            ...
                            backup: function(links, player) {
                                ...
                                return {
                                    direct: true,
                                    prompt: "令一名其他角色随机弃置装备区和手牌区的各一张牌，然后受到1点伤害",
                                    content: function() {
                                        'step 0'
                        ...
                        content: function() {
                            ...
                            if (result.bool) {
                                ...
                                if (get.color(cardx) == get.color(event.card)) {
                                    target.give(event.card, player, true);
                                } else {
                    ...
                    "radiance_xingyi": {
                        ...
                        intro: {
                            mark: function(dialog, storage, player, skill) {
                                ...
                                str += get.translation(list[1]) + "牌时回复一点体力<br>使用";
                    ...
                    "radiance_zhongluan": {
                        ...
                        prompt2: function(event, player) {
                            ...
                            var damage = event.player.getHistory('sourceDamage', function(evt) {
                                return evt.num > 0;
                            });
                            if (used.length == 0 && damage.length > 0) return "摸一张牌";
                        ...
                        content: function() {
                            ...
                            if (used.length == 0) {
                                var damage = trigger.player.getHistory('sourceDamage', function(evt) {
                                    return evt.num > 0;
                                });
                                player.draw((damage.length > 0 ? 2 : 1));
                            } else {
                    ...
                    "radiance_shouyue": {
                        ...
                        check: function(card) {
                            ...
                            return base / Math.max(0.1, get.value(card));
                        },
                        position: 'he',
                        selectCard: [1, 1],
                        discard: false,
                    ...
                    "radiance_kaiyang": {
                        ...
                        prompt2: function(event, player) {
                            ...
                            if (red.length > black.length) return "对其造成一点火焰伤害或弃置其一张牌";
                            return "弃置其一张牌";
                        },
                        content: function() {
                            'step 0'
                            ...
                            player.discardPlayerCard(1, trigger.player, !bool, 'he').set('ai', function(button) {
                                ...
                                return val;
                            }).set('bool', bool).set('prompt', "弃置" + get.translation(trigger.player) + "一张牌" + (bool ? "，若不弃置则对其造成一点火焰伤害" : ""));
                            'step 1'
                            if (!result.bool && event.bool) {
                    ...
                    "radiance_wuying": {
                        ...
                        ai: {
                            ...
                            respondShan: true,
                            skillTagFilter: function(player) {
                                if (!player.hasSkill('radiance_wuying_af')) return false;
                                if (!player.countCards('hes')) return false;
                            },
                            effect: {
                                target: function(card, player, target, current) {
                                    if ((get.tag(card, 'respondSha') || get.tag(card, 'respondShan')) && player.hasSkill('radiance_wuying_af')) return 0.6
                                }
                            }
                        },
                    },
                    "radiance_duanju": {
                        ...
                        content: function() {
                            ...
                            if (result.bool) {
                                ...
                                // player.storage.radiance_duanju.push(trigger.card);
                            } else {
                                event.finish();
                            }
                            'step 2'
                    ...
                    "radiance_duanju_db": {
                        mod: {
                            attackFrom: function(from, to, current) {
                                if (from.storage.radiance_duanju_db) return current + from.storage.radiance_duanju_db;
                            },
                        },
                        mark: true,
                        marktext: "断",
                    ...
                    "radiance_yingmu": {
                        ...
                        content: function() {
                            ...
                            for (var i = 0; i < targets.length; i++) {
                                num = Math.max(num, targets[i].getAttackRange() - 1);
                            };
                    ...
                    "radiance_lunxin": {
                        ...
                        content: function() {
                            ...
                            'step 3'
                            event.playerx.discardPlayerCard(player, 'he', "弃置" + get.translation(player) + "的一张牌，或点【取消】令其失去一点体力摸一张牌").set('ai', function(button) {
                    ...
                    "radiance_huhuo": {
                        ...
                        content: function() {
                            ...
                            target.chooseControl("弃牌", "伤害").set('ai', function() {
                                ...
                                "受到" + get.translation(player) + "造成的一点火焰伤害且其摸一张牌",
                            ]).set('prompt', "狐火：请选择一项：");
                            'step 2'
                            if (result.index == 0) {
                            ...
                            if (result.cards && result.cards.length) {
                                ...
                                for (var i = result.cards.length - 1; i >= 0; i--) {
                                    if (get.color(result.cards[i]) == 'black' && get.type(result.cards[i]) != 'equip') togain.push(result.cards[i]);
                                };
                                if (togain.filterInD('d').length > 0) player.gain(togain.filterInD('d'), 'gain2', 'log');
                        ...
                        content: function() {
                            ...
                            if (result.bool) {
                                player.chooseControl(['拆牌', '摸牌'], function() {
                                    ...
                                    return 1;
                                }).set('prompt', '斗艳：请选择一项').set('choiceList', [
                            ...
                            if (equip) player.gain(equip, 'gain2');
                        },
                        ai: {
                            order: 15,
                            result: {
                    ...
                    "radiance_tiancai": {
                        ...
                        content: function() {
                            ...
                            if (result.bool) {
                                ...
                                for (var i = 0; i < num; i++) {
                                    player.storage.radiance_tiancai[effect[i]] = suits[i];
                                    game.log(player, "切换了", 'radiance_tiancai', "使用", suits[i], "牌时的效果为", map[effect[i]]);
                                };
                            };
                        },
                        group: ['radiance_tiancai_draw', 'radiance_tiancai_give', 'radiance_tiancai_add', 'radiance_tiancai_look'],
                        subfrequent: ['draw', 'look'],
                        subSkill: {
                            draw: {
                                trigger: {
                                    player: 'useCard2',
                                ...
                                frequent: true,
                                filter: function(event, player, name) {
                                    if (name == 'useCardToTargeted') return false;
                            ...
                            give: {
                                ...
                                content: function() {
                                    'step 0'
                                    player.chooseTarget(1, "添彩：是否令一名其他角色获得" + get.translation(trigger.card) + "？", lib.filter.notMe).set('ai', function(target) {
                                        return get.value(trigger.cards, target) * get.attitude(_status.event.player, target);
                                    });
                                    'step 1'
                                    if (result.bool) {
                                        if (!event.isMine()) game.delayx();
                            ...
                            add: {
                                ...
                                direct: true,
                                filter: function(event, player, name) {
                                    if (name == 'useCardToTarget') return false;
                                ...
                                content: function() {
                                    'step 0'
                                    player.chooseTarget('添彩：是否额外指定一名' + get.translation(trigger.card) + '的目标？', function(card, player, target) {
                                        var trigger = _status.event.getTrigger();
                            ...
                            look: {
                                ...
                                filter: function(event, player, name) {
                                    if (name == 'useCardToTargeted') return false;
                                    return get.suit(event.card) == player.storage.radiance_tiancai.look;
                                },
                                content: function() {
                                    'step 0'
                                    player.draw(2);
                    ...
                    "radiance_hongse": {
                        ...
                        content: function() {
                            ...
                            for (var i = 0; i < 4; i++) {
                                var card = get.cardPile(function(cardx) {
                                    return suits.contains(get.suit(cardx));
                                });
                                if (card) {
                            ...
                            mark: function(dialog, content, player) {
                                ...
                                if (cards && cards.length) {
                                    if (player == game.me || player.isUnderControl()) {
                                        ...
                                        return '共有' + get.cnNumber(cards.length) + '张“色”';
                                    }
                                }
                            },
                        },
                        group: ['radiance_hongse_gain', 'radiance_hongse_judge', 'radiance_hongse_judge2'],
                        subSkill: {
                            gain: {
                                trigger: {
                                    player: 'phaseDrawBegin2'
                    ...
                    "radiance_huoluan": {
                            ...
                            return game.hasPlayer(function(current) {
                                ...
                                for (var i = 0; i < es.length; i++) {
                                    if (game.hasPlayer(function(current2) {
                                            return current != current2 && !current2.isMin() && current2.canEquip(get.subtype(es[i]), false);
                                        })) {
                                        return true;
                                    };
                                };
                        ...
                        content: function() {
                            ...
                            player.choosePlayerCard('e', "将" + get.translation(targets[0]) + "装备区内的一张牌移动给" + get.translation(targets[1]), true, function(button) {
                                ...
                                return _status.event.targets1.canEquip(get.subtype(button.link)) && !player.storage.radiance_huoluan.contains(get.subtype(button.link));
                            });
                            'step 1'
                            if (result.bool && result.links.length) {
                            ...
                            'step 2'
                            if (targets[1] == player && !player.storage.radiance_huoluanx) {
                                player.storage.radiance_huoluanx = true;
                            } else {
                            ...
                            result: {
                                target: function(player, target) {
                                    ...
                                    if (ui.selected.targets.length == 0) {
                                        ...
                                        if (bool1 && att > 0) return 6;
                                        return -6;
                                    } else {
                                        if (target == player && !player.storage.radiance_huoluanx) return 4;
                    ...
                    "radiance_tuanjie": {
                        ...
                        content: function() {
                            ...
                            if (player.isMaxHandcard()) {
                                player.chooseTarget(1, "是否令一名角色回复一点体力？", function(card, player, target) {
                    ...
                    "radiance_yujian": {
                        ...
                        content: function() {
                            ...
                            player.chooseCardTarget({
                                ...
                                prompt2: (name + "是否弃置一张手牌，视为对一名其他角色使用一张【杀】"),
                                filterCard: function(card, player) {
                                    return lib.filter.cardDiscardable(card, player)
                                },
                                position: 'h',
                            ...
                            effect: {
                                target: function(card, player, target) {
                                    if (get.tag(card, 'damage') && player.hasSkill('radiance_huaici')) {
                                        ...
                                        var judge = target.hp == 1 ? 3 : 1;
                                        if (get.name(card) == 'sha' && card.radiance_yujian && judge > 1) return [0.5, -1, 1.5, 1]; // [对目标效果倍率，对目标效果加算，使用者收益倍率，使用者收益加算]
                                        if (get.name(card) == 'sha') return [judge / 2, 0, 1.5, 1]
                    ...
                    "radiance_yingling": {
                        ...
                        content: function() {
                            ...
                            if (num == 0) {
                                ...
                                var str = event.triggername == 'damageBegin1' ? "是否弃置" + get.cnNumber(num) + "张牌对" + get.translation(trigger.player) + "额外造成1点伤害？" : "是否弃置" + get.cnNumber(num) + "张牌来减少" + (trigger.source ? get.translation(trigger.source) + "对你的" : "此") + "伤害？";
                                dialog.addText(str);
                    ...
                    "radiance_longjuan": {
                        ...
                        content: function() {
                            ...
                            player.chooseTarget(1, event.bool, event.bool ? "选择一名角色将其一张牌移动给你" : "是否再移动一张牌？", function(card, player, target) {
                                ...
                                var max = -1;
                                for (var i = 0; i < es.length; i++) {
                                    if (get.value(es[i], target) < 0 && get.value(es[i], player) > 0) {
                                        max = Math.max(max, get.value(es[i], player) + get.sgn(get.attitude(player, target)) * get.value(es[i], target));
                                    } else {
                                        max = Math.max(max, get.value(es[i], player));
                                    };
                                };
                                if (get.attitude(player, target) <= 0) return max;
                                return -1;
                            });
                            'step 2'
                            if (result.bool) {
                            ...
                            order: function(item, player) {
                                ...
                                for (var i = 1; i < 6; i++) {
                                    ...
                                    if (game.hasPlayer(function(target) {
                                            ...
                                            if (equip && player.canEquip(equip)) return true;
                                            return false;
                                        })) {
                                        count++;
                                    };
                                ...
                                if (player.hp <= 1 && count > 0) return 2;
                                return -1;
                            },
                            result: {
                                player: function(player) {
                    ...
                    "radiance_tianze": {
                        ...
                        selectCard: [0, 1],
                        check: function(card) {
                            return (3 - get.value(card)) / (get.number(card) + 0.5);
                        },
                        content: function() {
                            'step 0'
                            event.num = 0;
                            ...
                            if (result.index == 0) {
                                ...
                                player.gain(event.cardsx.filterInD('cod'), 'gain2', 'log');
                            };
                        },
                        ai: {
                            order: 13,
                    ...
                    "radiance_quhai": {
                        ...
                        content: function() {
                            ...
                            target.chooseBool("去害：是否失去一点体力？不失去体力会被弃置装备牌").set('ai', function(event, player) {
                                var source = event.player;
                            ...
                            result: {
                                target: function(player, target) {
                                    ...
                                    if (target.getEquip(1)) {
                                        max = Math.max(3.5 * num - get.value(target.getEquip(1), target), max);
                                    };
                        ...
                        ai: {
                            ...
                            result: {
                                player: function(player) {
                                    ...
                                    game.countPlayer(function(current) {
                                        var base = -2;
                                        if (current.hp <= 1) base = -4;
                                        if (current.hp == 2) base = -3;
                                        if (current.hasSkillTag('maihp') && current.hp > 1) base /= 2;
                                        if (choices[0](null, player, current)) {
                                            eff1 += get.attitude(player, current) * base;
                                            return true;
                                        }
                                        if (choices[1](null, player, current)) {
                                            eff2 += get.attitude(player, current) * base;
                                            return true;
                                        }
                                        return false;
                                    });
                                    if (player.hp >= 3 || player.countCards('h', 'tao')) return Math.max(eff1, eff2);
                                    if (player.hp <= 2 && player.countCards('h', 'jiu')) return Math.max(eff1, eff2) - 1;
                                    return 0;
                                },
                            },
                        },
                    ...
                    "radiance_wenyi": {
                        ...
                        subSkill: {
                            ...
                            damage: {
                                ...
                                content: function() {
                                    'step 0'
                                    player.chooseTarget(get.prompt('radiance_wenyi'), '对一名回合回复过体力的其他角色造成1点伤害', function(card, player, target) {
                        ...
                        subSkill: {
                            minus: {
                                mod: {
                                    attackFrom: function(from, to, current) {
                                        if (game.hasPlayer(function(target) {
                                                return target != from && target.hasSkill('radiance_juyan');
                                            })) return current + from.countMark('radiance_juyan');
                                    },
                                },
                                charlotte: true,
                            },
                    ...
                    "radiance_pojian": {
                        ...
                        filter: function(event, player, name) {
                            ...
                            if (!player.isDisabled(3) && (player.getEquip(3) || player.storage.radiance_zaixin)) return true;
                            if (!player.isDisabled(4) && (player.getEquip(4) || player.storage.radiance_zaixin)) return true;
                        ...
                        content: function() {
                            ...
                            next.set('prompt', "破茧：废除一个装备栏并摸一张牌");
                            ...
                            if (equip && !player.storage.radiance_zaixin) {
                                player.addToExpansion(equip, 'giveAuto', 'log', player).gaintag.add('radiance_pojian');
                            };
                            'step 2'
                    ...
                    "radiance_huangli": {
                        ...
                        mod: {
                            ...
                            targetEnabled: function(card, player, target, now) {
                                if (player.isDisabled(3) && player.isDisabled(4) && get.type(card) == 'delay') return false;
                            },
                        },
                    },
                    "radiance_zaixin": {
                        ...
                        ai: {
                            ...
                            skillTagFilter: function(player, tag, target) {
                                if (player != target || player.storage.radiance_zaixin) return false;
                            },
                            save: true,
                            result: {
                                player: function(player) {
                    ...
                    "radiance_xiangyun": {
                        ...
                        filter: function(event, player, name) {
                            ...
                            if (name == 'useCardToTargeted') return event.player != event.target;
                            return true;
                        },
                        frequent: true,
                        locked: false,
                    ...
                    "radiance_suping": {
                        ...
                        content: function() {
                            ...
                            if (result.bool) {
                                ...
                                target.addTempSkill('radiance_suping_af');
                                if (cards.length > 0) {
                                    target.addToExpansion(cards, 'giveAuto', target).gaintag.add('radiance_suping_af');
                                };
                            } else {
                                player.getHistory('custom').push({
                            ...
                            player.chooseTarget("是否令一名其他角色获得“肃平”？", function(card, player, target) {
                                return target != player && !target.hasSkill('radiance_suping');
                            }).set('ai', function(target) {
                                var player = _status.event.player;
                            ...
                            if (result.bool) {
                                ...
                                result.targets[0].addTempSkill('radiance_suping', {
                                    player: 'phaseAfter',
                                });
                                if (result.targets[0].ai.shown > 0) player.addExpose(0.3);
                            };
                        },
                        mod: {
                            cardUsableTarget: function(card, player, target) {
                                if (player.getHistory('custom', function(evt) {
                                        return evt.radiance_suping == target;
                                    }).length > 0) return false;
                            },
                        },
                        ai: {
                    ...
                    "radiance_suping_af": {
                        ...
                        charlotte: true,
                        filter: function(event, player) {
                            return player.getExpansions('radiance_suping_af').length > 0;
                        },
                        content: function() {
                            'step 0'
                            var cards = player.getExpansions('radiance_suping_af');
                            player.gain(cards, 'draw');
                            game.log(player, '收回了' + get.cnNumber(cards.length) + '张“肃平”牌');
                            'step 1'
                            player.removeSkill('radiance_suping_af');
                        },
                        intro: {
                            markcount: 'expansion',
                            mark: function(dialog, storage, player) {
                    ...
                    "radiance_leiren": {
                        ...
                        mod: {
                            attackFrom: function(from, to, current) {
                                return current - Math.ceil(from.getDamagedHp() / 1);
                            },
                            cardUsable: function(card, player, num) {
                                if (get.name(card, player) == 'sha' && player.getDamagedHp() >= 3) return num + 1;
                            },
                        },
                    ...
                    "radiance_caishe": {
                        ...
                        init: function(player, skill) {
                            if (!player.storage.radiance_caishe) {
                                ...
                                // player.addSkillBlocker('radiance_caishe');
                            };
                        },
                        ...
                        content: function() {
                            ...
                            player.chooseTarget(get.prompt2('radiance_caishe'), forced, function(card, player, target) {
                                return target != player && target.getSkills(true, false, false).length > 0;
                            }).set('ai', function(target) {
                            ...
                            var func = function(id, list) {
                                ...
                                for (var i = 0; i < list.length; i++) {
                                    var str = '<div class="popup text" style="width:calc(100% - 10px);display:inline-block">';
                                    str += get.translation(list[i]) + "（" + list[i] + ((lib.skill[list[i]] && lib.skill[list[i]].charlotte) ? "，为技能后续效果标记）" : "）");
                                    str += '</div>';
                                    var next = choiceList.add(str);
                                    next.firstChild.addEventListener(lib.config.touchscreen ? 'touchend' : 'click', ui.click.button);
                            ...
                            next.set('ai', function(button) {
                                ...
                                var rank = get.skillRank(skill, cond);
                                if (rank) {
                                    if (info.limited && !player.awakenedSkills.contains(skill) && cond == 'in') return rank *= 3;
                    ...
                    "raidance_shenyi": {
                        ...
                        content: function() {
                            'step 0'
                            player.chooseTarget(1, get.prompt2('raidance_shenyi'), function(card, player, target) {
                                return true;
                            }).set('ai', function(target) {
                                var player = _status.event.player;
                                var current = player.storage.radiance_jinian_current || player;
                            ...
                            if (result.bool) {
                                var target = result.targets[0];
                                event.target = target;
                                player.logSkill('raidance_shenyi', target);
                                var list = [];
                                if (target.hp > 2) {
                                    list.push("变为2血");
                                } else {
                            ...
                            var difference = 0;
                            if (choice == "变为2血") {
                                difference = target.hp - 3;
                                target.hp = 2;
                                target.update();
                                if (difference > 0) {
                                    target.storage.raidance_shenyi_af = (target.storage.raidance_shenyi_af || 0) + difference;
                                    target.addTempSkill('raidance_shenyi_af', {
                                        player: 'phaseAfter',
                                    });
                                };
                            } else if (choice == "回复满血") {
                                target.recover(2048, player, 'nocard');
                                target.storage.raidance_shenyix = true;
                                target.addTempSkill('raidance_shenyi_af', {
                                    player: 'phaseAfter',
                                });
                            } else {
                                target.hp = 0;
                                target.update();
                                var next = target.dying();
                                var next2 = next.insertAfter(function() {
                                    target.hp = event.num;
                                    target.update();
                                }, {
                                    player: player,
                                    target: target,
                                    num: Math.max(target.hp, 1),
                                });
                            };
                        },
                        mod: {
                            targetInRange: function(card, player, target) {
                                return;
                                if (target.hasSkill('raidance_shenyi_af')) return true;
                            },
                        },
                        ai: {
                            expose: 0.3,
                    ...
                    "raidance_shenyi_af": {
                        ...
                        intro: {
                            mark: function(dialog, content, player) {
                                if (player.storage.raidance_shenyix) return "回合结束时将体力值变为2";
                                if (!player.storage.raidance_shenyi_af) return "神意无后续效果";
                                if (player.storage.raidance_shenyi_af > 0) return "回合结束时回复" + player.storage.raidance_shenyi_af + "点体力";
                                // if (player.storage.raidance_shenyi_af < 0) return "回合结束时失去" + (0 - player.storage.raidance_shenyi_af) + "点体力";
                            },
                        },
                        trigger: {
                            player: ["phaseEnd"],
                        ...
                        content: function() {
                            'step 0'
                            if (player.storage.raidance_shenyix) {
                                player.hp = 2;
                                player.update();
                            };
                            if (!player.storage.raidance_shenyi_af) return;
                            if (player.storage.raidance_shenyi_af > 0) {
                                player.recover(player.storage.raidance_shenyi_af, 'nocard');
                                // player.randomDiscard(player.storage.raidance_shenyi_af);
                            } else if (player.storage.raidance_shenyi_af < 0) {
                                var num = 0 - player.storage.raidance_shenyi_af;
                                if (player.hp <= num) num = player.hp - 1;
                                if (num > 0) {
                                    player.loseHp(num);
                                    //player.draw(num);
                                };
                            ...
                            'step 1'
                            player.removeSkill('raidance_shenyi_af');
                        },
                        onremove: function(player, skill) {
                            delete player.storage.raidance_shenyi_af;
                            delete player.storage.raidance_shenyix;
                        },
                    },
                    "radiance_jinian": {
                        trigger: {
                        ...
                        filter: function(event, player, name) {
                            ...
                            if (phase.skill == 'radiance_jinian') return false;
                            return player.hasMark('radiance_jinian');
                        },
                        usable: 1,
                        intro: {
                            content: "摸牌阶段额外摸#张牌",
                        ...
                        content: function() {
                            player.removeMark('radiance_jinian');
                            var next = player.insertPhase('radiance_jinian', false);
                            player.storage.radiance_jinian_current = _status.currentPhase;
                            var next2 = game.createEvent('radiance_jinian_clear', false, next);
                            next2.player = player;
                            next2.setContent(function() {
                                delete player.storage.radiance_jinian_current;
                            });
                        },
                        group: ['radiance_jinian_add', 'radiance_jinian_draw'],
                        subSkill: {
                            add: {
                                trigger: {
                                    global: 'roundStart',
                                ...
                                silent: true,
                                content: function() {
                                    player.addMark('radiance_jinian');
                                },
                            },
                            draw: {
                                trigger: {
                                ...
                                forced: true,
                                filter: function(event, player) {
                                    return !event.numFixed && player.hasMark('radiance_jinian');
                                },
                                content: function() {
                                    trigger.num += Math.min(10, player.countMark('radiance_jinian'));
                                },
                            },
                            used: {
                                charlotte: true,
                    ...
                    "radiance_yekong": {
                        ...
                        content: function() {
                            ...
                            next.set('next2', next2);
                            next.set('filterMove', function(from, to, moved) {
                                // if ([1, 2, 3].contains(to) && moved[1].length + moved[2].length + moved[3].length >= 2) return false;
                                return true;
                            });
                            next.set('filterOk', function(moved) {
                            ...
                            next.processAI = function(list) {
                                ...
                                if (!next2.hasWuxie()) {
                                    for (var i = 0; i < judges.length; i++) {
                                        var judge = get.judge(judges[i]);
                                        cards.sort(function(a, b) {
                                            return (judge(b) * Math.max(0.1, get.value(b, player)) - judge(a) * Math.max(0.1, get.value(a, player))) * att_cur;
                                        });
                                        if (judge(cards[0]) < 0) {
                                            stopped = true;
                                            break;
                                ...
                                var todiscard = [];
                                while (cards.length > 0 && todiscard.length + top.length < 2) {
                                    todiscard.push(cards.shift());
                                };
                                return [cards, top, [], todiscard];
                            };
                            'step 3'
                ...
                translate: {
                    ...
                    "radiance_pofa_af": "破法",
                    "radiance_zhisu": "质素",
                    "radiance_zhisu_info": "出牌阶段限一次，你摸X张牌；若这些牌中有点数为1、2、3、5、7、J、K的牌，你可以展示之并对一名其他角色造成等量的伤害。（X为你已损失的体力值且至少为1）",
                    "radiance_guiji": "轨迹",
                    "radiance_guiji_info": "当一名角色使用牌指定你为目标时，你可以令此牌对你无效并令一名其他角色代替你成为此牌的目标（可以选择非法角色），然后你跳过其他于指定目标、成为目标时、后的结算；若此牌目标数为1，你可以再为其添加一个目标；若此牌不为伤害牌或目标数大于1，你摸两张牌。最后你失去1点体力。",
                    "radiance_aofa": "奥法",
                    ...
                    "radiance_aofa_db": "奥法",
                    "radiance_jingyao": "晶耀",
                    "radiance_jingyao_info": "限定技，出牌阶段，你可以将至多三张牌置于武将牌上。你的准备阶段开始时，移除你武将牌上的一张牌。只要你武将牌上有“晶耀”牌，你“奥法”的摸牌数+1。",
                    ...
                    "radiance_xuling": "虚灵",
                    "radiance_xuling_info": "当你成为其他角色的基本牌或非延时类的锦囊牌的目标后，你可以失去1点体力，令该牌对你无效，然后你可以令一名手牌数少于体力值的角色摸两张牌或令一名手牌数多于体力值的角色弃置两张手牌。",
                    "radiance_mojian": "魔剑",
                    ...
                    "radiance_cangkong_info": "出牌阶段限一次，你可以废除“贯断”的一个条件或减1点体力上限，然后选择一名攻击范围内的角色，其随机弃置装备区和手牌区的各一张牌，然后受到1点伤害。",
                    "radiance_ponian": "破念",
                    ...
                    "radiance_zhenyan": "箴言",
                    "radiance_zhenyan_info": "摸牌阶段，你可以放弃摸牌，改为从牌堆中选等量类型不同的牌获得。",
                    "radiance_zhongluan": "终乱",
                    "radiance_zhongluan_info": "一名角色的回合结束时，若其本回合：<br>未使用过伤害牌，你可以摸一张牌，且若其造成过伤害，额外摸一张牌；<br>使用过伤害牌且造成的伤害数小于X，你可以对其造成1点伤害。（X为你已损失的体力值且至少为1)",
                    "radiance_weipo": "威迫",
                    ...
                    "radiance_shezheng_info": "出牌阶段限一次，你将一张手牌置于一名没有“摄”的其他角色武将牌上，称为“摄”。有“摄”的角色以摸牌阶段通常摸牌以外的方式获得牌后，你摸一张牌；当你以此法摸了五张牌后，其移去“摄”；其回合结束时若其仍有“摄”，其获得之，然后若你以此法获得的牌数少于三张，其可以视为使用一张无距离限制的【杀】。",
                    ...
                    "radiance_kaiyang": "开阳",
                    "radiance_kaiyang_info": "其他角色的回合结束时，若本回合有进入弃牌堆的红色牌且数量不小于黑色牌数，你可以弃置其一张牌；若严格大于，你可以改为对其造成1点火焰伤害。",
                    "radiance_wuying": "舞英",
                    "radiance_wuying_info": "你的回合外，当你每回合第一次成为其他角色牌的目标后，你令其选择一项：1.你获得X张♥牌；2.你本回合可以将任意一张手牌当做【杀】或【闪】使用或打出。（X为其体力值减去你的体力值且至少为1至多为3）你的♥牌不计入手牌上限。",
                    "radiance_duanju": "断拒",
                    "radiance_duanju_info": "当你成为其他角色的【杀】或者非延时类锦囊牌的目标时，可以令使用者弃置你一张牌，然后直至回合结束与其攻击范围-X。然后若你不在该角色的攻击范围内，取消之；若此牌对你造成了伤害，你获得使用者的X张牌。（若弃置的牌为装备牌则X为2，否则为1）",
                    "radiance_duanju_db": "断拒",
                    "radiance_yingmu": "鹰目",
                    "radiance_yingmu_info": "出牌阶段限一次，你摸X张牌。你的手牌上限+X。（X为你的攻击范围或攻击范围内有你的角色的攻击范围-1中的最大值，至少为1，至多为5）",
                    "radiance_lunxin": "论心",
                    "radiance_lunxin_info": "出牌阶段限一次，你可以令两名有手牌的角色拼点。若如此做，你摸两张牌，且可以令发起者的拼点牌点数+或-至多X。然后赢的角色选择一项：1.弃置你的一张牌；2.你失去一点体力并摸一张牌。（X为你已失去的体力值）",
                    "radiance_zhihe": "志和",
                    "radiance_zhihe_info": "当一名其他角色使用【杀】时，若其选择了你或你攻击范围内的角色为目标，你可以选择一项：1.令你成为此【杀】的唯一目标，然后你将手牌补至体力上限（至少摸一张，至多摸五张)；2.若你不是目标，你额外成为此牌的目标，然后此【杀】的使用者受到一点伤害。",
                    "radiance_huhuo": "狐火",
                    "radiance_huhuo_info": "出牌阶段，你可以弃置一张黑色手牌并令一名其他角色选择一项：1.令你弃置其区域内的至多两张牌，你获得以此法弃置的黑色非装备牌，若无牌可得则其横置；2.受到一点火焰伤害，然后你摸一张牌。若两个选项本回合均有人选择过，此技能失效直至当前阶段结束。",

                    "radiance_caopan": "操盘",
                    "radiance_caopan_info": "你的结束阶段，你可以选择至多三名其他角色，你令这些角色分别独立选择一项：1.交给你一张基本牌；2.弃置一张非基本牌；3.令你摸两张牌。若你选择了至少两名角色且他们的选择均相同，你回复1点体力；若你以此法获得了不少于三张牌，你翻面。",
                    "radiance_tunji": "囤积",
                    ...
                    "radiance_kongyin": "空音",
                    "radiance_kongyin_info": "出牌阶段每项各限一次：1.将一张手牌交给一名其他角色，令其失去1点体力；2.弃置至少两张花色各不同的手牌，令一名其他角色摸X张牌并翻面。（X为4减去弃置的牌数）",
                    "radiance_chuilian": "垂怜",
                    "radiance_chuilian_info": "一名角色受到伤害后，若该角色受到此伤害前未受伤，你可以摸一张牌。每轮第一次你已受伤且不因自身受伤触发此技能时，你回复1点体力。",
                    "radiance_douyan": "斗艳",
                    "radiance_douyan_info": "出牌阶段限一次，你可以与一名其他角色拼点。若你赢，你直至回合结束你对该角色使用牌无距离限制，且你选择一项效果获得：1.其手牌对你可见，你可以将一张手牌当作【过河拆桥】对该角色使用；2.你使用牌指定该角色为目标后摸一张牌。若你没赢，该角色下个回合的弃牌阶段跳过。最后，你获得一张装备牌。",
                    ...
                    "radiance_gongqiao_info": "一名其他角色使用【杀】造成伤害时，你可以展示并交给伤害来源一张手牌。若此牌为黑色，此伤害+1；若为红色，你回复1点体力。",
                    "radiance_lizhan": "历战",
                    ...
                    "radiance_tiancai": "添彩",
                    "radiance_tiancai_info": "①当你使用一张牌时，你可以根据其花色执行对应效果：·♥：摸一张牌；·♦：令一名其他角色获得此牌的实体牌；·♠：为此牌增加一个合法目标；·♣：摸两张牌然后弃两张牌。<br>②每次你的回合开始时，你可以切换①中花色与效果的对应顺序。",
                    "radiance_hongse": "虹色",
                    "radiance_hongse_info": "游戏开始时，额外分发给你四张花色各不同的牌，你选择四张作为起始手牌，其余牌作为“色”置于你的武将牌上。摸牌阶段，你可以获得任意张“色”然后少摸等量的牌。一名角色进行判定时，你可以打出一张“色”代替之；未以此法改判的判定结束时，你可以将判定牌置入“色”。",
                    "radiance_huoluan": "惑乱",
                    "radiance_huoluan_info": "出牌阶段限两次，你可以将一名角色装备区内的一张本阶段未以此法移动过的类型的装备牌移动至另一名角色的装备区。若此次不为“你本阶段第一次以此法获得装备”，失去了装备牌的角色视为对获得了牌的角色使用了一张无视防具的【杀】。",
                    "radiance_zhemian": "遮面",
                    "radiance_zhemian_info": "转换技，当你受到伤害时，若伤害来源为男性/女性，你可以摸一张牌并令此伤害-1；若不为，你也可以选择切换至另一项。",

                    "radiance_tuanjie": "团结",
                    "radiance_tuanjie_info": "出牌阶段限一次，你可以令所有角色依次选择将一张手牌交给其他角色并摸一张牌。然后若你为全场手牌最多的角色，你可以令一名角色回复一点体力。",
                    "radiance_xisheng": "牺牲",
                    ...
                    "radiance_zhenjie": "贞洁",
                    "radiance_zhenjie_info": "当你成为其他角色的【杀】或非延时类锦囊牌的目标后，若此牌只有一个目标，你可以与使用者拼点。若你赢，此牌对你无效；若你没赢，你获得对方的拼点牌和以你为目标的牌，然后此回合不能再使用此技能。",
                    "radiance_dianlu": "典录",
                    "radiance_dianlu_info": "每回合限X次，当与你距离1或以内的角色使用或打出一张【闪】后，你可以摸一张牌。你与其他角色计算距离时-X。（X为你已损失的体力值且至少为1）",
                    "radiance_dizui": "涤罪",
                    "radiance_dizui_info": "你的回合外，当你失去一张牌后，你可以选择一名攻击范围内本回合未选择过的角色。该角色直至回合结束技能全部失效，且你令其打出一张【闪】。若不打出，其受到1点雷电伤害。（场上有角色濒死时伤害延后至濒死后结算）",
                    "radiance_suzheng": "肃正",
                    "radiance_suzheng_info": "①一名其他角色的出牌阶段开始前，你可以令该角色选择一项：1.将一张与你的“肃正”牌花色均不同的手牌置于你的武将牌上；2.受到你造成的1点伤害，然后获得所有“肃正”牌并跳过出牌阶段和弃牌阶段，你直至你的下个回合开始不能再发动“肃正”。<br>②准备阶段，你可以移去所有“肃正”牌。当你于本局游戏中已累计移去或令其他角色获得过的“肃正”牌中包含四种花色时，你将“移去”改为“获得”。",
                    ...
                    "radiance_yingling_info": "①当你造成伤害时，你可以弃置一张牌令此伤害+1，然后下一次发动时弃牌数+1。<br>②当你受到伤害时，你可以弃置一张牌令此伤害-1，然后下一次发动时弃牌数+1。<br>③每轮游戏开始时，重置此技能的数值。",
                    "radiance_tianshu": "天枢",
                    ...
                    "radiance_yujian": "羽箭",
                    "radiance_yujian_info": "弃牌阶段开始时，你可以弃置一张手牌并视为对一名其他角色使用了一张【杀】。若此【杀】未造成伤害，你跳过弃牌阶段。",
                    "radiance_huaici": "怀慈",
                    "radiance_huaici_info": "每阶段每个牌名限一次，你使用一张牌对一名角色造成伤害时，可以令此伤害-1，然后摸三张牌。",
                    "radiance_huaici_ai": "怀慈",
                    "radiance_jinghun": "净魂",
                    "radiance_jinghun_info": "每回合限一次，当你使用非伤害牌指定一名其他角色为目标后，或当你造成伤害后，可以令目标/受伤角色选择一项：1.其摸一张牌，然后你摸三张牌；2.你与其各摸一张牌，然后你获得其区域内的一张牌。",
                    "radiance_longjuan": "龙卷",
                    "radiance_longjuan_info": "限定技，出牌阶段，你可以将场上任意数量的牌移动至你对应的区域内。",
                    "radiance_jiahu": "加护",
                    "radiance_jiahu_info": "锁定技，你的手牌上限+X，出牌阶段可以额外使用X张【杀】。（X为你装备区内的牌数）",
                    "radiance_waidao": "外道",
                    "radiance_waidao_info": "出牌阶段限一次，你可以令所有其他角色分别独立选择是否将一张牌交给你。若这些牌的点数中有唯一最大，将该牌交给你的角色可以视为使用一张非延时类锦囊牌；若没有，你可以视为使用一张非延时类锦囊牌。",
                    "radiance_diankuang": "癫狂",
                    "radiance_diankuang_info": "觉醒技，结束阶段，若你本回合没跳过出牌阶段且因“外道”获得的牌数不大于一张，你加两点体力上限，回复两点体力，失去“外道”并获得“生祭”。",
                    "radiance_shengji": "生祭",
                    "radiance_shengji_info": "锁定技，每次你的结束阶段，你失去一点体力，然后可以视为使用一张非延时类锦囊牌。你受到伤害的回合结束时你减一点体力上限，然后可以视为使用一张基本牌。",
                    ...
                    "radiance_shengfa": "圣罚",
                    "radiance_shengfa_info": "出牌阶段，你可以弃置X张牌，对你攻击范围内的一名其他角色造成1点伤害。（X为本回合此技能发动的次数，包括当前）",
                    "radiance_yunming": "运命",
                    "radiance_yunming_info": "一名角色的判定牌生效前，你可以打出一张黑色牌。若如此做，你选择此判定结果的点数和花色。",
                    "radiance_tianze": "天择",
                    "radiance_tianze_info": "出牌阶段限一次，你可以弃置〇或一张牌，然后选择顺时针或逆时针，按此顺序所有角色依次弃置一张点数比上一张牌大的手牌，直至有角色不如此做或所有角色均已弃置；若有其他角色不如此做，你可以选择一项：1.对该角色造成1点伤害；2.获得其他角色因此弃置的所有牌。",
                    "radiance_tianxuan": "天璇",
                    "radiance_tianxuan_info": "当你进行判定前，你可以随机观看四种花色的牌各一张，选择其中一张牌并获得，此次判定结果视为此牌。",
                    "radiance_xianyue": "仙乐",
                    "radiance_xianyue_info": "出牌阶段开始时，你可以翻面，然后获得以下效果直至下回合开始：<br>1.每名角色限一次，当其造成伤害时，你可以令其判定：若结果为黑色，此伤害+1；否则你摸一张牌；<br>2.每名角色限一次，当其受到伤害时，你可以令其判定。若结果为红色，此伤害-1；否则你摸一张牌。<br>若你为进行判定的角色且结果为摸牌时，改为摸两张牌。",

                    "radiance_xianyi": "仙衣",
                    "radiance_xianyi_info": "锁定技，当你的体力值变化后，若这是本局游戏中你的体力值第一次变为该值，你摸三张牌并回复1点体力。",
                    "radiance_quhai": "去害",
                    "radiance_quhai_info": "出牌阶段，你可以选择一名装备区内有牌的角色，令其选择一项：1.令你弃置其装备区内的一张牌，若为武器牌其摸X张牌，若不为你本阶段不能再对其发动此技能；2.失去1点体力，然后此技能本阶段失效。（X为你本回合此前已发动“去害”的次数，至多为3）",
                    "radiance_heyu": "鹤羽",
                    "radiance_heyu_info": "当一名角色成为其他角色的【杀】或非延时类的锦囊牌的唯一目标后，你可以令该牌对目标角色无效，然后你持续展示牌堆顶的牌，直至出现与已有的【鹤羽】牌花色均不同的牌。你获得这些牌，然后将一张与【鹤羽】牌花色均不同的手牌置于武将牌上。若展示的牌数不为两张，你失去1点体力。",
                    "radiance_xianci": "仙赐",
                    "radiance_xianci_info": "锁定技，你武将牌上每有一张【鹤羽】牌，其他角色计算与你的距离时+1，你的手牌上限+1。你可以将两张颜色相同的【鹤羽】牌当作【桃】使用。",

                    "radiance_qiongguang": "穹光",
                    "radiance_qiongguang_info": "出牌阶段，你可以弃置一张手牌并展示牌堆顶两张牌。若这两张牌的点数互质，你选择一名其他角色，将这两张牌任意分配给你和该角色，然后你对其造成1点伤害；否则你令一名角色获得这两张牌。若你弃置的牌的点数不为质数或一名角色本阶段以此法获得至少两张牌后，此技能本阶段失效。",
                    "radiance_tianji": "天玑",
                    ...
                    "radiance_yindun": "隐遁",
                    "radiance_yindun_info": "锁定技，你不会成为【南蛮入侵】、【万箭齐发】和【闪电】的目标；当一张【南蛮入侵】或【万箭齐发】结算完毕后，你回复1点体力。",
                    "radiance_huoshi": "祸世",
                    "radiance_huoshi_info": "出牌阶段限一次，你可以选择所有体力值不大于你或不小于你的角色，你与这些角色各失去1点体力。若有角色在此结算中死亡，每有一名你摸两张牌。",
                    "radiance_jiguang": "极光",
                    "radiance_jiguang_info": "每回合限一次，你可以视为使用或打出了一张未以此法选择过的任意基本牌或者非延时类锦囊牌；以此法使用的牌无距离限制。",
                    "radiance_tianquan": "天权",
                    "radiance_tianquan_info": "你的回合结束时，你可以摸一张牌，且若你体力值为全场唯一最低，改为回复1点体力或摸两张牌；然后你可以恢复一个“极光”已用牌名。",
                    "radiance_jimie": "迹灭",
                    ...
                    "radiance_wenyi": "瘟疫",
                    "radiance_wenyi_info": "一名其他角色回复体力后，你记录其，然后可以弃置其一张牌；你的结束阶段开始时，你可以对一名记录过的角色造成1点伤害，然后清空所有记录。",
                    "radiance_yujia": "驭假",
                    ...
                    "radiance_mengdu": "猛毒",
                    "radiance_mengdu_info": "出牌阶段限一次，你可以令一名有手牌的其他角色展示所有手牌。若其有【杀】或【闪】，其需选择一项：1.弃置所有【杀】和【闪】；2.失去1点体力；若其没有，你摸X张牌。（X为其手牌中的基本牌数且至少为1）",
                    "radiance_weihao": "危号",
                    "radiance_weihao_info": "锁定技，你每回合使用的第一张【杀】指定所有其他角色为目标；此你【杀】命中后，你摸一张牌；此【杀】结算完毕后，若造成过伤害，你失去1点体力。",
                    "radiance_baoyan": "爆炎",
                    "radiance_baoyan_info": "锁定技，你对体力值小于你的角色造成的伤害+1。你造成大于一点的伤害后，可以摸X张牌。（X为此伤害-1）",
                    "radiance_shihun": "噬魂",
                    "radiance_shihun_info": "你杀死一名角色后，可以回复两点体力并摸等同于其体力上限张牌（至多五张）。",
                    "radiance_pojian": "破茧",
                    "radiance_pojian_info": "游戏开始时，你从牌堆中装备不同类型的装备各一张。准备阶段或当你受到伤害后，你可以将装备区内一张牌置于武将牌上并废除其对应的装备栏。",
                    "radiance_pojianx": "破茧·改",
                    "radiance_pojianx_info": "游戏开始时，你从牌堆中装备不同类型的装备各一张。结束阶段或当你受到伤害后，你可以废除装备区内的一个装备栏。",
                    "radiance_huangli": "煌丽",
                    "radiance_huangli_info": "锁定技，你每废除一个装备栏，摸牌阶段额外摸一张牌。若你的武器栏被废除，你使用【杀】的次数上限+2；若你的防具栏被废除，你的手牌上限+2；若你的两个坐骑栏均废除，你不能成为延时类锦囊的合法目标。",
                    "radiance_zaixin": "再新",
                    ...
                    "radiance_chilie": "炽烈",
                    "radiance_chilie_info": "锁定技，准备阶段，你摸三张牌；你跳过判定阶段；结束阶段，你失去1点体力。你使用牌无距离限制，【杀】的次数上限+1，手牌上限无限。",
                    ...
                    "radiance_xiangyun_info": "当你使用或打出红桃牌时，或当你成为其他角色红桃牌的目标后，可以摸一张牌；你的♥牌不计入手牌上限。",
                    "radiance_suping": "肃平",
                    "radiance_suping_info": "出牌阶段开始时，你可以与一名其他角色拼点。若你赢，直至回合结束将其所有手牌移出游戏，你与其距离视为1，然后你可以令一名其他角色获得“肃平”直至该角色回合结束；若你没赢，本回合你不能对其使用牌。",
                    "radiance_suping_af": "肃平",
                    "radiance_xiaohu": "虓虎",
                    ...
                    "radiance_qiongjiu_info": "当你成为其他角色的【杀】或非延时类的锦囊牌的目标后，你可以失去1点体力，令该牌对你无效。然后你可以将一张牌置于弃牌堆并从弃牌堆中获得一张点数为该牌倍数或因数的牌。",

                    "radiance_shiren": "失刃",
                    "radiance_shiren_info": "出牌阶段限一次，你可以对一名攻击范围内的角色造成一点伤害。若如此做，直至你的下一个回合开始，你的所有【闪】均视为【杀】，你使用【杀】无距离限制。",
                    ...
                    "radiance_rongbi": "熔壁",
                    "radiance_rongbi_info": "每轮你不限次数，每名其他角色限一次，当一名角色成为【杀】的目标后，你可以将一张手牌置于牌堆顶，然后令该角色装备牌堆中的一张其装备区内没有对应类型的装备牌；然后根据此装备的类型：·武器：你对【杀】的使用者造成一点伤害；·坐骑：目标与你各摸一张牌；·其他类型或牌堆中没有能装备的牌：此【杀】对目标无效。",
                    "radiance_chunzhu": "春祝",
                    "radiance_chunzhu_info": "摸牌阶段，你可以额外摸等同于场上装备了武器牌的角色数一半的牌（向上取整）；场上每有一名角色装备了防具牌，你的手牌上限+1。",

                    "radiance_zhaoyao": "招摇",
                    "radiance_zhaoyao_info": "出牌阶段开始前，你可以摸至多三张牌。然后若你的手牌为全场唯一最多，你需选择一项：1.失去1点体力；2.此阶段的自由时点只能使用一张牌。",
                    ...
                    "radiance_baoji": "暴击",
                    "radiance_baoji_info": "当你使用【杀】或【决斗】造成伤害时，可以进行一次判定。若判定结果为黑色，或在判定结果为红色时你选择失去1点体力，则此伤害+1。",
                    "radiance_jiabei": "加倍",
                    "radiance_jiabei_info": "当你要因为摸牌而获得牌前，可以声明一个颜色或花色。若这次你将要获得的牌中有此颜色/花色，你额外摸一/两张牌。",

                    "radiance_wenyu": "温愈",
                    "radiance_wenyu_info": "出牌阶段，你可以选择一名已受伤的角色并弃置X张牌，令该角色回复1点体力。然后你进行一次判定。若不为红桃，该角色的X值+1；若为黑色，此技能本阶段失效。一名角色濒死时，其X值-1。（X基础值为2，至少为1）",
                    ...
                    "radiance_leiren": "雷刃",
                    "radiance_leiren_info": "当你脱离濒死状态后，你可以对当前回合角色造成一点雷电伤害。你的攻击范围+X，若X：≥ 1：你摸牌阶段额外摸一张牌，≥ 3：出牌阶段可以额外使用一张【杀】。（X为你已失去的体力值）",
                    ...
                    "raidance_shenyi": "神意",
                    "raidance_shenyi_info": "回合开始时，你可以选择一名角色并选择一项：1.若其体力值大于2，将其体力值调整至2，其下个回合结束时回复X-1点体力；2.若其体力值不大于2，其将体力调整至濒死，若其此濒死后未死亡其将体力值调整至X；3.若其已受伤，令其回复至体力上限，其下个回合结束时将体力值调整至2。（X为以此法调整前后的体力值差值，此体力调整不视为伤害、失去体力或体力值变化）",
                    "raidance_shenyi_af": "神意",
                    "radiance_jinian": "纪年",
                    "radiance_jinian_info": "每轮开始时,你获得一个“纪”标记。摸牌阶段，你额外摸“纪”数量的牌。不为以此法获得的回合限一次，当一名角色濒死的结算后，你可以移去一个“纪”，然后在当前回合结束后进行一个额外的回合。",
                    "radiance_mengmei": "梦魅",
