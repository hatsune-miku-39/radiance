            ...
            var radiance_pack = {
                ...
                characterSort: {
                    "mode_extension_星耀璨然": {
                        ...
                        "radiance_union": [
                            "radiance_un004_reine", "radiance_un007_huangqiqiao",
                        ],
                        "radiance_church": [
            ...
            skill: {
                skill: {
                    ...
                    "radiance_junhun": {
                        ...
                        marktext: "军",
                        group: ['radiance_junhun_sha', 'radiance_junhun_damage']
                    },
                    "radiance_junhun_sha": {
                    ...
                    "radiance_shangwu": {
                        ...
                        content: function() {
                            'step 0'
                            trigger.source.chooseBool('是否对' + get.translation(player) + '发动【尚武】？').set('choice', get.attitude(trigger.source, player) > 1);
                            'step 1'
                            if (result.bool) {
                ...
                translate: {
                    ...
                    "radiance_yanzhen": "严阵",
                    "radiance_yanzhen_info": "当一张非延时类锦囊牌被【无懈可击】响应后，你可以获得该锦囊牌。你的非延时类锦囊牌不会被【无懈可击】响应。",
                    "radiance_hunlie": "魂烈",
                    ...
                    "radiance_xianyue": "仙乐",
                    "radiance_xianyue_info": "出牌阶段开始时，你可以翻面，然后获得以下效果直至下回合开始：每名角色限一次，<br>1.你的武将牌为正面朝上，当其造成伤害时，你可以令其判定：若结果为黑色，此伤害+1；否则你摸一张牌；<br>2.你的武将牌为背面朝上时，当其受到伤害时，你可以令其判定。若结果为红色，此伤害+1；否则你摸一张牌。若你为进行判定的角色则两项各限一次，且结果为摸牌时改为摸两张牌。",
                    "radiance_yunming": "运命",
                    ...
                    "radiance_duanming_info": "出牌阶段开始，你可以弃置一张黑色牌。若如此做，直至回合结束，除你以外的所有角色技能失效，不能获得牌，非濒死状态不能使用或打出牌。",
