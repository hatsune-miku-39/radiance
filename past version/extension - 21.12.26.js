        ...
        content: function(config, pack) {
            ...
            var radiance_pack = {
                ...
                characterSort: {
                    "mode_extension_星耀璨然": {
                        "radiance_magic": [
                            "radiance_ma002_dai", "radiance_ma004_watersky", "radiance_ma005_maria", "radiance_ma009_draco",
                        ],
                        "radiance_heng": [
                        ...
                        "radiance_underworld": [
                            "radiance_fr001dk_lotustar", "radiance_ud002_agares", "radiance_ud005_doris",
        ...
        package: {
            ...
            skill: {
                        ...
                        chooseButton: {
                            ...
                            check: function(button) {
                                ...
                                if (effect > 0 && player.countCards('hes', function(card) {
                                        return player.getUseValue(card) < effect && get.type(card, player) != 'basic';
                                    }) > 0) return effect;
                                return 0;
                            },
                    ...
                    "radiance_heyu": {
                        ...
                        content: function() {
                            ...
                            if (card) {
                                ...
                                player.storage.radiance_heyu.add(card);
                                player.$gain2(card);
                        ...
                        chooseButton: {
                            ...
                            check: function(button) {
                                ...
                                if (ui.selected.buttons.length == 1) {
                                    ...
                                    if (selected == 'r' && target.isTurnedOver) return get.attitude(player, target) - 1;
                                };
                                return 0;
                            },
                            backup: function(links, player) {
                        ...
                        content: function() {
                            ...
                            if (result.bool) {
                                ...
                                event.target2.chooseToRespond({
                                    ...
                                    if (get.effect(trigger.target, 'sha', trigger.player, player) > get.effect(player, 'sha', trigger.player, player)) return 0;
                ...
                translate: {
                    ...
                    "radiance_tianyi": "天仪",
                    "radiance_tianyi_info": "每名角色的回合限一次，你可以将一张非基本牌当作任意基本或非延时类锦囊牌使用或打出。",
                    "radiance_pofa": "破法",
                    ...
                    "radiance_heyu": "鹤羽",
                    "radiance_heyu_info": "当一名角色成为其他角色的基本牌或非延时类的锦囊牌的唯一目标后，你可以失去一点体力，令该牌对目标角色无效，然后你持续展示牌堆顶的牌，直至出现与已有的【鹤羽】牌花色均不同的牌。你将此牌置于武将牌上，然后获得其余的牌。你武将牌上每有一张【鹤羽】牌，其他角色计算与你的距离时+1，你的手牌上限+1。",
                    "radiance_xianci": "仙赐",
                    "radiance_xianci_info": "你可以将两张颜色相同的【鹤羽】牌当作【桃】使用。",
