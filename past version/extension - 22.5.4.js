        ...
        content: function(config, pack) {
            ...
            var radiance_pack = {
                character: {
                    ...
                    "radiance_ma017_aurora": ["female", "radiance_group_magic", 3, ["radiance_huangdao", "radiance_xingyi"],
                        []
                    ],
                    ...
                    "radiance_ud010_fortune ": ["none", "radiance_group_underworld", 4, ["radiance_tingzhi", "radiance_sansheng"],
                        []
                    ],
                ...
                characterSort: {
                    "mode_extension_星耀璨然": {
                        ...
                        "radiance_heaven": [
                            "radiance_hv001_reine", "radiance_hv003_norn", "radiance_hv015_veronia",
                        ...
                        "radiance_underworld": [
                            ...
                            "radiance_ud006_pestilence", "radiance_ud007_wangruize", "radiance_ud008_rosa", "radiance_ud009_xunsishen", "radiance_ud010_fortune ",
                            "radiance_ud011_crimsoul", "radiance_zhuomu",
                        ],
                        "radiance_lost": [
            ...
            skill: {
                skill: {
                    ...
                    "radiance_huangdao": {
                        ...
                        content: function() {
                            ...
                            if (player != trigger.player) {
                                player.chooseToDiscard(1, 'he', "是否弃一张牌来发动“黄道”？").set('ai', function(card) {
                                    var player = _status.event.player;
                                    var trigger = _status.event.getTrigger();
                    ...
                    "radiance_kaiyang": {
                        ...
                        logTarget: 'player',
                        check: function(event, player) {
                            return get.damageEffect(event.player, player, player, 'fire');
                        },
                        content: function() {
                ...
                translate: {
                    ...
                    "radiance_huangdao_info": "准备阶段，你可以从弃牌堆中选择一张牌置于牌堆顶；其他角色的准备阶段，你可以弃置一张牌来如此做。",
                    "radiance_xingyi": "星移",
                    ...
                    "radiance_lizheng": "力争",
                    "radiance_lizheng_info": "当你使用的【杀】指定目标后，可以令目标角色选择一项：1.打出一张【杀】并令你摸一张牌，然后此【杀】对其无效且不计入使用次数限制；2.其受到1点对应牌为此【杀】的伤害。",
                    "radiance_kaiyang": "开阳",
                    ...
                    "radiance_chuilian_info": "一名角色受到伤害后，若该角色受到此伤害前未受伤，你可以摸一张牌，且若该角色不为你，你回复1点体力。",
                    "radiance_douyan": "斗艳",
                    ...
                    "radiance_tianze": "天择",
                    "radiance_tianze_info": "出牌阶段限一次，你选择顺时针或逆时针，由你开始，按此顺序所有角色依次弃置一张点数比上一张牌大的手牌，直至有角色不如此做或所有角色均已弃置；若有其他角色不如此做，你可以选择一项：1.对该角色造成1点伤害；2.获得其他角色因此弃置的所有牌。",
