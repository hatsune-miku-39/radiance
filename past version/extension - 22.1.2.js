        ...
        package: {
            ...
            skill: {
                ...
                translate: {
                    ...
                    "radiance_mingyong_info": "锁定技，当你受到伤害时，改为失去一点体力。当你失去体力后，你展示当前回合角色的手牌。若其不为你，你可以弃置其至多三张花色相同的手牌，且若你没有此花色的手牌，你获得一张；若你不能以此法弃牌，则你可以获得你手牌中缺少的花色的牌各一张。",
                    ...
                    "radiance_wanxiang_info": "出牌阶段开始时，你可以与一名其他角色拼点。若你赢，视为你使用了任意一张非延时类锦囊牌（无距离限制）；若你没赢，你不能使用锦囊牌且锦囊牌不计入手牌上限，直至回合结束。",
