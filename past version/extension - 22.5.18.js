        ...
        content: function(config, pack) {
            ...
            var radiance_pack = {
                character: {
                    ...
                    "radiance_fr002_lizhaoyue": ["female", "radiance_group_free", 4, ["radiance_suping", "radiance_xiaohu"],
                ...
                characterSort: {
                    "mode_extension_星耀璨然": {
                        ...
                        "radiance_heaven": [
                            "radiance_hv003_norn", "radiance_hv004_reine",
            ...
            skill: {
                skill: {
                    ...
                    "radiance_suping": {
                        ...
                        content: function() {
                            ...
                            if (result.bool) {
                                ...
                                if (cards.length > 0) {
                                    target.addSkill('radiance_suping_af');
                    ...
                    "radiance_xiaohu": {
                        ...
                        content: function() {
                            'step 0'
                            player.chooseTarget(ge.prompt2('radiance_xiaohu')).set('ai', function(target) {
                                var trigger = _status.event.getTrigger();
                ...
                translate: {
                    ...
                    "radiance_fengdong_info": "准备阶段，你可以选择一名有手牌的其他角色展示所有手牌，然后你选择其一个花色的手牌并选择一至两项：1.该角色每有一种此花色的牌，你摸一张牌；2.该角色本回合不能使用或打出与此花色不同的牌，受到此花色的牌造成的伤害+1。若同时选择两项，你失去1点体力。",
                    ...
                    "radiance_yingmu": "鹰目",
                    "radiance_yingmu_info": "出牌阶段限一次，你摸X张牌。（X为你的攻击范围，至少为1，至多为5）",
                    "radiance_lunxin": "论心",
                    ...
                    "radiance_xiaohu": "虓虎",
                    "radiance_xiaohu_info": "当两名角色拼点的结果亮出后，若你未翻面，你可以翻面并选择其中一名角色，其视为拼点赢（点数为15），然后你获得双方的拼点牌并从牌堆获得一张点数位于两张拼点牌原本点数之间（闭区间）的牌。",
                    "radiance_baiyi": "百艺",
