                ...
                skill: {
                    ...
                    "radiance_yingling": {
                        ...
                        content: function() {
                            ...
                            var str = event.triggername == 'damageBegin1' ? "是否弃置" + get.cnNumber(num) + "张牌对" + get.translation(trigger.player) + "额外造成1点伤害？" : "是否弃置" + get.cnNumber(num) + "张牌来防止" + (trigger.source ? get.translation(trigger.source) + "对你的" : "此") + "伤害？";
                            dialog.addText(str);
