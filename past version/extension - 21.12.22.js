        ...
        content: function(config, pack) {
            ...
            var radiance_pack = {
                character: {
                    ...
                    "radiance_ma012_kicker": ["male", "radiance_group_magic", 4, ["radiance_baoji", "radiance_jiabei"],
                        []
                    ],
                    ...
                    "radiance_he015_yunzhongzi": ["male", "radiance_group_heng", 4, ["radiance_yunjian", "radiance_leiyin"],
                        []
                    ],
                ...
                translate: {
                    ...
                    "radiance_he015_yunzhongzi": "云中子",

                    "radiance_un002_schwarz": "舒华兹侯爵",
            ...
            skill: {
                skill: {
                    ...
                    "radiance_yunjian_af": {
                        ...
                        filter: function(event, player) {
                            return event.card && event.card.name == 'sha' && event.card.radiance_yunjian && event.addCount;
                        },
                        content: function() {
                            if (player.stat[player.stat.length - 1].card.sha > 0) {
                            ...
                            if (list.length == 0) {
                                ...
                                player.chooseControlList("风影", list, function(event, player) {
                                    ...
                                    if (_status.event.controls.length == 2) {
                                        if (num2 - num1 > 2 || num1 == 0) return 0;
                                        return 1;
                ...
                translate: {
                    ...
                    "radiance_jiaomei": "娇媚",
                    "radiance_jiaomei_info": "出牌阶段，若你本阶段没有造成过伤害，你可以选择一名其他角色，交给其一张伤害牌，然后其选择一项：1.对另一名你选择的角色使用一张【杀】（无距离限制，伤害来源视为你），然后你可以观看并获得其一张非伤害牌；2.将手牌补至四张并翻面。结束阶段，若你本回合使用“娇媚”的次数大于1，你失去一点体力。",
                    "radiance_tianhua": "天华",
                    ...
                    "radiance_fengying_info": "锁定技，准备阶段，若此时不是你的第一个回合，你将手牌弃置至与你的体力上限相同。若你因此弃牌，你可以选择一项：1.切换“蝶舞”的性别；2.回复一点体力。",
