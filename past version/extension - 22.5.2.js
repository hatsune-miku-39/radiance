        ...
        package: {
            ...
            skill: {
                ...
                translate: {
                    ...
                    "radiance_kaiyang": "开阳",
                    "radiance_kaiyang_info": "出牌阶段，若你本回合没有造成过伤害，你可以弃置一张红色手牌并选择一名其他角色，该角色全部技能失效且不能使用或打出牌直至此技能结算完毕，然后你亮出牌堆顶两张牌。若这些牌中有红色牌，你对该角色造成1点火焰伤害。最后你获得展示牌中的伤害牌和武器牌。",
                    ...
                    "radiance_huiwang": "辉望",
                    "radiance_huiwang_info": "①每回合限一次，当你成为其他角色伤害或失去牌效果的牌的目标后，你可以摸一张牌。<br>②每回合每名角色限一次，当你攻击范围内的角色成为其以外的角色的伤害或失去牌效果的牌的目标后，若其体力值不大于/大于1且本回合内其成为此类牌目标的次数不小于1/2，你可以摸一张牌，然后交给其一张牌。",
                    ...
                    "radiance_zhuomu": "灼暮",
                    "radiance_zhuomu_info": "锁定技，其他角色的结束阶段，若其攻击范围内没有你，其可以选择一项：1.失去一点体力值并随机使用一张武器牌；2.令你摸一张牌。若其有“惧”，则其必须选择一项，且其可以同时执行两项并移去所有“惧”，那个场合选项2的摸牌数改为其“惧”数。",

                    "radiance_tingzhi": "停滞",
                    "radiance_tingzhi_info": "其他角色的回合开始时，你可以失去一点体力并选择一个花色，该角色于此回合内仅能使用或打出此花色的牌。",
                    "radiance_tingzhi_db": "停滞",
                    "radiance_sansheng": "三生",
                    "radiance_sansheng_info": "其他角色的弃牌阶段结束时，若其于此阶段失去的牌不少于三张，你可以对其造成一点伤害。",
