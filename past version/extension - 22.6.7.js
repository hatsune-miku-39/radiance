        ...
        content: function(config, pack) {
            ...
            var radiance_pack = {
                character: {
                    ...
                    "radiance_un017_qiuguxun": ["female", "radiance_group_union", 3, ["radiance_tiancai"],
                        ['forbidai']
                    ],
                    ...
                    radiance_shuangbi: function(player) {
                        if (typeof player.storage.radiance_shuangbi == 'boolean') {
                            if (player.storage.radiance_shuangbi) {
                                return "转换技，当你使用伤害牌指定一名其他角色为目标后，你可以<span class='bluetext'>摸一张牌</span>。";
                            } else {
                                return "转换技，当你使用伤害牌指定一名其他角色为目标后，你可以<span class='bluetext'>令目标角色非锁定技失效直至回合结束且其不能使用或打出牌响应此牌</span>。";
                            }
                        }
        ...
        package: {
            ...
            skill: {
                skill: {
                    ...
                    "radiance_tiancai": {
                        ...
                        content: function() {
                            ...
                            player.chooseButton(dialog, 8).set('filterButton', function(button) {
                            ...
                            if (result.bool) {
                                ...
                                for (var i = 0; i < 4; i++) {
                                    player.storage.radiance_tiancai[result.links[(2 * i)]] = result.links[(2 * i + 1)];
                                    game.log(player, "切换了", 'radiance_tiancai', "使用", result.links[(2 * i + 1)], "牌时的效果为", map[result.links[(2 * i)]]);
                                };
                            };
                        },
                        ...
                        subSkill: {
                            ...
                            give: {
                                ...
                                filter: function(event, player) {
                                    ...
                                    return get.suit(event.card) == player.storage.radiance_tiancai.give;
                                },
                                content: function() {
                                    'step 0'
                                    ...
                                    if (result.bool) {
                                        ...
                                        target.gain(trigger.cards.filterInD('od'));
                                    };
                                },
                            },
                            add: {
                                ...
                                filter: function(event, player) {
                                    ...
                                    return get.suit(event.card) == player.storage.radiance_tiancai.add;
                                },
                                content: function() {
                                    'step 0'
                ...
                translate: {
                    ...
                    "radiance_tiancai": "添彩",
                    "radiance_tiancai_info": "①当你使用一张牌时，你可以根据其花色执行对应效果：·♥：摸一张牌；·♦：令一名其他角色获得此牌的实体牌；·♠：为此牌增加一个合法目标；·♣：卜算2.②每次你的回合开始时，你可以切换①中花色与效果的对应顺序。",
                    "radiance_huoluan": "惑乱",
                    ...
                    "radiance_suzheng": "肃正",
                    "radiance_suzheng_info": "一名其他角色的出牌阶段开始前，你可以令该角色选择一项：1.将一张与你的“肃正”牌花色均不同的手牌置于你的武将牌上；2.受到你造成的1点伤害，然后获得你的“肃正”牌并跳过出牌阶段和弃牌阶段，直至你的下一个回合开始你不能再发动“肃正”。准备阶段，你可以移去所有“肃正”牌。",
                    ...
                    "radiance_juyan": "惧魇",
                    "radiance_juyan_info": "准备阶段，你可以令一名你选择的或两名随机的其他角色获得“惧”标记。一名角色每有一个“惧”标记攻击范围便-1。",
                    "radiance_zhuomu": "灼暮",
