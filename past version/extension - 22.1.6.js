    ...
    return {
                ...
                characterSort: {
                    "mode_extension_星耀璨然": {
                        "radiance_magic": [
                            ...
                            "radiance_ma011_zero", "radiance_ma015_luia",
                        ],
                        "radiance_heng": [
                        ...
                        "radiance_free": [
                            ...
                            "radiance_fr011_alabai", "radiance_fr012_kicker", "radiance_fr015_xiuyin",
                ...
                dynamicTranslate: {
                    ...
                    "radiance_renlin": function(player) {
                        if (player.storage.radiance_renlin) {
                            return "游戏开始时，你可以随机使用一张武器牌。其他角色的武器牌进入弃牌堆后，你可以获得之。你的武器牌不计入手牌上限。<span class='legendtext'>限定技，当一名角色进入濒死状态时，你可以重铸一张武器牌，然后该角色回复等量的体力。</span>";
                        }
        ...
        package: {
            ...
            skill: {
                ...
                translate: {
                    "radiance_zhu": "主公",
                    "radiance_zhu_info": "<span class='firetext'>主公增强：</span>游戏开始时，你加X点体力上限；你的摸牌阶段额外摸X张牌。你不会成为【乐不思蜀】的目标。当一名忠臣死亡后，若你的体力上限大于1，你减1点体力上限。（X为存活忠臣数）",
                    ...
                    "radiance_mingke": "铭刻",
                    "radiance_mingke_info": "出牌阶段限一次，你可以将一张黑色手牌当作你本局游戏中已经使用过的一张基本牌或锦囊牌使用。",
                    "radiance_kongzhi": "空值",
