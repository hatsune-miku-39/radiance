        ...
        package: {
            ...
            skill: {
                skill: {
                    ...
                    "radiance_mengdu": {
                        ...
                        content: function() {
                            ...
                            event.sha = sha;
                            if (sha.length > 0) {
                                target.chooseBool("弃置手牌中所有的【杀】和【闪】，或者不弃置并受到1点伤害").set('ai', function() {
                    ...
                    "radiance_baiyi": {
                        ...
                        content: function() {
                            'step 0'
                            event.num = cards.length;
                            var str = "弃置" + get.cnNumber(event.num * 2) + "张手牌，或受到1点伤害并令" + get.translation(player) + "摸" + get.cnNumber(event.num) + "张牌";
                    ...
                    "radiance_mengmei": {
                        ...
                        filter: function(event, player) {
                            ...
                            return !(event.getParent().name == 'draw' && event.getParent(2).name == 'phaseDraw') && event.player.countCards('h') > player.countCards('h');
                        },
                        logTarget: "player",
                        check: function(event, player) {
                            return get.attitude(player, event.player) < 0;
                ...
                translate: {
                    ...
                    "radiance_huiwang": "辉望",
                    "radiance_huiwang_info": "①每回合限一次，当你成为其他角色伤害或失去牌效果的牌的目标后，你可以摸一张牌。<br>②每回合每名角色限一次，当其他角色成为其以外的角色的伤害或失去牌效果的牌的目标后，若其体力值不大于/大于1且本回合内其成为此类牌目标的次数不小于1/2，你可以摸一张牌，然后交给其一张牌。",
                    ...
                    "radiance_juyan": "惧魇",
                    "radiance_juyan_info": "准备阶段，你可以令一名你选择的或两名随机的其他角色获得“惧”标记。一名角色每有一个“惧”标记攻击范围便-1。其他角色与你计算距离时+X。（X为场上拥有“惧”的角色数）",
                    "radiance_zhuomu": "灼暮",
                    ...
                    "radiance_mengdu": "猛毒",
                    "radiance_mengdu_info": "出牌阶段限一次，你可以令一名有手牌的其他角色展示所有手牌。若其有【杀】或【闪】，其需选择一项：1.弃置所有【杀】和【闪】；2.失去1点体力。",
                    "radiance_weihao": "危号",
                    ...
                    "radiance_mengmei": "梦魅",
                    "radiance_mengmei_info": "每轮每名角色限一次，当一名其他角色在摸牌阶段以外获得牌后，若其手牌数多于你，你可以令其交给你一张手牌。",
                    "radiance_yekong": "夜空",
                    "radiance_yekong_info": "你的准备阶段、当你受到1点伤害或失去1点体力后，你可以摸三张牌，然后将至少两张牌置于牌堆顶、牌堆底或弃置。",
                },
            },
