                ...
                characterSort: {
                    "mode_extension_星耀璨然": {
                        ...
                        "radiance_union": [
                            ...
                            "radiance_un013_gaius", "radiance_un017_qiuguxun",
                        ],
                        "radiance_church": [
                        ...
                        "radiance_null": [
                            "radiance_000_infinity", "radiance_002_airin",
                        ],
                    },
                },
                skill: {},
        ...
        package: {
            ...
            skill: {
                    ...
                    "radiance_wuying": {
                        ...
                        content: function() {
                            ...
                            trigger.player.chooseControl(["选项一", "选项二"]).set('ai', function(event, player) {
                                ...
                                if (player.hp - event.player.hp < 2) return 0;
                                return 1;
                            }).set('choiceList', [
                ...
                translate: {
                    ...
                    "radiance_kaiyang": "开阳",
                    "radiance_kaiyang_info": "其他角色的回合结束时，若本回合有进入弃牌堆的红色牌且数量不小于黑色牌数，你可以对其造成1点火焰伤害。",
                    "radiance_wuying": "舞英",
                    "radiance_wuying_info": "你的回合外，当你每回合第一次成为其他角色牌的目标后，你令其选择一项：1.你获得X张♥牌；2.你本回合可以将任意一张牌当做【杀】或【闪】使用或打出。（X为其体力值减去你的体力值且至少为1至多为3）",
                    "radiance_duanju": "断拒",
