        ...
        content: function(config, pack) {
            ...
            var radiance_pack = {
                character: {
                    ...
                    "radiance_nh007_sarah": ["female", "radiance_group_free", 3, ["radiance_yidai", "radiance_renlin", "radiance_jianguang"],
                        []
                    ],
                ...
                characterSort: {
                    "mode_extension_星耀璨然": {
                        ...
                        "radiance_underworld": [
                            "radiance_fr001dk_lotustar", "radiance_ud002_agares", "radiance_ud007_wangruize"
                        ],
                        "radiance_nonhuman": [
                            "radiance_fr001ft_lotustar", "radiance_nh001_luna", "radiance_nh003_rose", "radiance_nh004_maya",
                            "radiance_nh007_sarah",
                            "radiance_nh011_wawel", "radiance_nh012_hydra",
                        ],
                        "radiance_free": [
                            "radiance_fr001_lotustar", "radiance_fr008_xiuyin",
                            "radiance_fr006_yunzhongzi",
                ...
                characterTitle: {
                    ...
                    "radiance_fr001_lotustar": "赤之勇者",
                    "radiance_fr001ft_lotustar": "崩日之使",
                    "radiance_fr001dk_lotustar": "黑之血徒",
            ...
            skill: {
                skill: {
                    ...
                    "radiance_fengying": {
                        ...
                        content: function() {
                            ...
                            if (event.direct || !result.bool) {
                                player.chooseBool("是否将“蝶舞”的性别切换至" + (player.storage.radiance_diewu == 'male' ? "女" : "男") + "性？").set('ai', function(event, player) {
                    ...
                    "radiance_yingzhi": {
                        ...
                        content: function() {
                            'step 0'
                            trigger.player.chooseBool('是否令' + get.translation(player) + '发动【英知】？').set('choice', get.attitude(trigger.player, player) >= 1);
                            'step 1'
                            if (result.bool) {
                                player.logSkill('radiance_yingzhi', trigger.player);
                                player.addMark('radiance_yingzhi', 1, false);
                            } else {
                                event.finish();
                            }
                            'step 2'
                            player.draw(player.countMark('radiance_yingzhi'));
                            'step 3'
                            if (player.countMark('radiance_yingzhi') > 2) player.removeMark('radiance_yingzhi', 3, false);
                        },
                    },
                    "radiance_chilie": {
                        trigger: {
                    ...
                    "radiance_yingxue": {
                        ...
                        subSkill: {
                                ...
                                silent: true,
                                filter: function(event, player) {
                                    return player.storage.radiance_yingxue > 0;
                                },
                                content: function() {
                                    'step 0'
                                    player.logSkill('radiance_yingxue');
                    ...
                    "radiance_zhanque": {
                        ...
                        content: function() {
                            ...
                            trigger.target.chooseTarget('斩却：选择一名响应的其他角色', true, function(target) {
                            ...
                            if (result.bool) {
                                ...
                                event.target2.chooseToRespond({
                                    ...
                                    if (trigger.target.countCards('h', 'shan') == 0) return 0;
                    ...
                    "radiance_zaowu": {
                        ...
                        check: function(card) {
                            var player = _status.event.player;
                            if (get.number(card) >= player.storage.radiance_zaowu && get.suit(card) == 'spade') {
                                return 9 - get.value(card);
                            }
                            return 6 - get.value(card);
                        },
                        ...
                        onuse: function(result, player) {
                            ...
                            if (get.number(result.card) >= player.storage.radiance_zaowu && get.suit(result.card) == 'spade') {
                ...
                translate: {
                    ...
                    "radiance_yingzhi": "英知",
                    "radiance_yingzhi_info": "一名角色使用【杀】命中后，该角色可以令你获得一个“英”标记，然后你摸X张牌。若X不小于3，你移除3个“英”。（X为“英”的数量且至多为3）",
                    "radiance_chilie": "炽烈",
                    "radiance_chilie_info": "锁定技，准备阶段，你摸三张牌；你跳过判定阶段；结束阶段，你失去一点体力。你使用牌无距离限制，【杀】的次数上限+1，手牌上限无限。",
                    "radiance_yaoguang": "摇光",
                    "radiance_yaoguang_info": "每种牌名限一次，当你使用或打出一张基本牌后，可以摸一张牌。当你的体力值减少后，重置此技能。",
                    "radiance_bengyao": "崩曜",
                    ...
                    "radiance_zaowu": "造物",
                    "radiance_zaowu_info": "出牌阶段，你可以将一张手牌当作【无中生有】使用。若你以此法使用的牌花色不为黑桃或点数小于本阶段已以此法使用过的牌，此技能本阶段失效。",
                    "radiance_sanyuan": "三元",
